                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <label class="col-md-2 text-right s-12"><strong>Foto Tempat :</strong></label>
                                        <label class="col-md-3 s-12">
                                            <a target="blank" class="btn btn-sm btn-primary" href="{{ config('app.sftp_src').'tempat/'.$pedagangAlamat->foto_tempat }}"><i class="icon icon-file"></i>Lihat File</a>
                                        </label>
                                    </div>
                                </div>
                            </div>
