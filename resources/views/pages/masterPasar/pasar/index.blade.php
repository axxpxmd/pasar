                            ...
                            <div class="form-row form-inline">
                                <div class="col-md-12">
                                    <div class="form-group m-0">
                                        <label for="nm_pasar" class="col-form-label s-12 col-md-4">Nama Pasar</label>
                                    ...
                                    <div class="form-group m-0">
                                        <label for="kd_pasar" class="col-form-label s-12 col-md-4">Kode Pasar</label>
                                        <input type="text" name="kd_pasar" id="kd_pasar" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
                                    <div class="form-group m-0">
                                    ...
                                    <div class="form-group m-t-5">
                                        ...
                                        <input type="text" name="latitude" id="latitude" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off"/>
                                    </div>
                                    <div class="form-group m-0">
                                        <label for="longitude" class="col-form-label s-12 col-md-4">Longitude</label>
                                        <input type="text" name="longitude" id="longitude" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off"/>
                                    </div>
...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            $('#id').val(data.id);
            $('#nm_pasar').val(data.nm_pasar).focus();
            $('#kd_pasar').val(data.kd_pasar);
            $('#luas_area').val(data.luas_area);
            $('#id_prov').attr('disabled','disabled')
            $('#id_kab').attr('disabled','disabled')
            $('#id_kec').attr('disabled','disabled')
            $('#id_kel').attr('disabled','disabled')
        }, "JSON").fail(function(){
            reload();
        });
    }
