...
class PedagangAlamatController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'status'  => 'required',
            'foto_tempat' => 'required|mimes:png,jpg,jpeg|max:1024'
        ]);
        ...
        $file_name_foto_tempat = time() . "." . $foto_tempat->getClientOriginalName();
        $foto_tempat->storeAs($path_sftp, $file_name_foto_tempat, 'sftp', 'public');
        ...
        $pedagangAlamat->foto_tempat = $file_name_foto_tempat;
        $pedagangAlamat->save();
